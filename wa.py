...
os.system("clear")
autoketik(f"""
{hijau}â•”â•گâ•—{merah}â”Œâ”€â”گâ”Œâ”€â”گâ”Œâ”¬â”گ  {biru}â•¦ â•¦â”¬ â”¬â”Œâ”€â”گâ”Œâ”¬â”گ{putih}â”Œâ”€â”گ{kuning}â”Œâ”€â”گâ”Œâ”€â”گ â”Œâ”€â”گ
{hijau}â•ڑâ•گâ•—{merah}â”œâ”€â”کâ”œâ”€â”¤â”‚â”‚â”‚  {biru}â•‘â•‘â•‘â”œâ”€â”¤â”œâ”€â”¤ â”‚ {putih}â””â”€â”گ{kuning}â”œâ”€â”¤â”œâ”€â”ک â”œâ”€â”ک
{hijau}â•ڑâ•گâ•‌{merah}â”´  â”´ â”´â”´ â”´  {biru}â•ڑâ•©â•‌â”´ â”´â”´ â”´ â”´ {putih}â””â”€â”ک{kuning}â”´ â”´â”´   â”´ {ungu}V1
{abu}-----------------------------------------
{putih}[{biru}â€¢{putih}] {biru}Author {putih}   : MarshallSetian
{putih}[{biru}â€¢{putih}] {abu}GitHub {putih}   : marshallsetian
{putih}[{biru}â€¢{putih}] {merah}You{putih}Tube {putih}  : marshall setian
{putih}[{biru}â€¢{putih}] {ungu}Instagram {putih}: @marshall_setian
{W}[{Y}â€¢{W}] Ip Kamu {putih}  :{Y} {ip}
{W}[{Y}â€¢{W}] Waktu/Jam {putih}:{Y} {localtime}
{W}[{Y}â€¢{W}] Total Run {putih}:{Y} {getvisit['value']}
""")

nomor = input(f"{W}[{R}â€¢ {kuning}â€¢{hijau}â€¢{W}] {biru}Nomor Target {W}: ")
